...
//     to: email,
//     subject: "AI Knots-System Registration OTP",
//     html: `<!DOCTYPE html>
// <html lang="en">
// <head>
//   <meta charset="UTF-8">
//   <title>AI Knots-System OTP Verification</title>
//   <style>
...
export default function getRegisterMailOptions(email, name) {
  return {
    from: process.env.EMAIL,
    to: email,
    subject: "AI Knots-System Registration Successful",
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Your registration to AI Knots System was successful. You can now log in and access your dashboard.</p>
    </div>
    <div class="footer">
      &copy; 2025 AI Knots System. All rights reserved.
    </div>
